...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    // IP de mi Url
    String IP = "http://servicios4android1.000webhostapp.com/servicios4Android1/";
    // Rutas de los Web Services
    String GET = IP + "/obtener_alumnos.php";
    String GET_BY_ID = IP + "/obtener_alumno_por_id.php";
    String GET_BY_ID_POST = IP + "/obtener_alumno_por_id_post.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        consultarporidpost = (Button)findViewById(R.id.consultaridpost);
        ...
        consultarporidpost.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.borrar:
                ...
                break;
            case R.id.consultaridpost:

                hiloconexion = new ObtenerWebService();
                hiloconexion.execute(GET_BY_ID_POST,"6",idendificador.getText().toString());   // Parámetros que recibe doInBackground
    ...
    public class ObtenerWebService extends AsyncTask<String,Void,String>{
        ...
        protected String doInBackground(String... params) {
            ...
            //--------------------------------------------------------------------
            else if(params[1]=="6"){    // get por post es una mezcla de get por id e insert
                ...
                try {
                    ...
                    if (respuesta == HttpURLConnection.HTTP_OK){
                        ...
                        //urlConn es el nombre de nuestra conexion (por get le llamabamos connection
